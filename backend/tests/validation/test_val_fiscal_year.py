...
from backend.utils.date_ranges import get_fiscal_year_range


@patch("backend.utils.date_ranges.date")
def test_fy_range_calculation_january(mock_date):
    ...
    start, end, year = get_fiscal_year_range(1)
...
def test_fy_range_calculation_april_current_cycle(mock_date):
    ...
    start, end, year = get_fiscal_year_range(4)
...
def test_fy_range_calculation_september_past_cycle(mock_date):
    ...
    start, end, year = get_fiscal_year_range(9)
